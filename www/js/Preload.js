...
Preload.prototype = {
	...
	preload: function()
    {
        ...
        this.game.load.spritesheet	("flytest", "assets/images/spr_FlyStrip.png", 64,64);
        this.game.load.tilemap	("Level1", "assets/sprite_physics/archie_testlevel.json",null, Phaser.Tilemap.TILED_JSON);
        ...
        this.game.load.image    ("archie_attack", "assets/images/Buttons/spr_retryBlue.png");
